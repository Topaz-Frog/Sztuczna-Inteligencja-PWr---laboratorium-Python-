...
class Board():
    ...
    def field_heur(self):
        ...
        return (w_score - b_score) * WEIGHT_FIELDS
    
    def pawn_heur(self):
        w_score = 2.5*self.w_pawns + 4*self.w_queens
        b_score = 2.5*self.b_pawns + 4*self.b_queens
        
        return (w_score - b_score) * WEIGHT_PAWNS
